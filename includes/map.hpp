...
namespace ft {
    ...
    class map {
        ...
        // types:
            ...
            explicit map(const value_compare& comp=value_compare(key_compare()), const Allocator& alloc= Allocator()): tree(comp), compare(key_compare()), allo(alloc){}
            template <class InputIterator>
            map(InputIterator first, InputIterator last, const value_compare& comp=value_compare(key_compare()), const Allocator& alloc= Allocator()): tree(comp), compare(key_compare()),allo(alloc){
